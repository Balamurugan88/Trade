    ...
    <body>
        <div class="col-sm-12">
            <div class="col-sm-12">
                ...
                <form method="post" action="<%=request.getContextPath()%>/admin/ExcelUpload?uploadType=customer&type=1&category=<%=request.getParameter("category")%>" enctype="multipart/form-data">
                        ...
                        <c:forEach items="${customerList}" var="customer">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<%=request.getContextPath()%>/admin/import/delete?id=${customer.id}&type=customer&category=<%=request.getParameter("category")%>"
