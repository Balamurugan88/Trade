<%-- 
    Document   : LeatherProducts
    Created on : Mar 15, 2017, 7:49:58 PM
    Author     : VISALI V
--%>
    ...
    <body>
        <div class="col-sm-12">
            <div class="col-sm-12">
                ...
                <form method="post" action="<%=request.getContextPath()%>/admin/ExcelUpload?uploadType=leather_products&category=5" enctype="multipart/form-data">
