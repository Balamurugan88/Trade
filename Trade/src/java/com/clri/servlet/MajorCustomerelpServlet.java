...
import com.clri.dao.MajorCustomerelpDAO;
 ...
 * @author Balamurugan
 */
public class MajorCustomerelpServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int count = 0;
        MajorCustomerelpDAO majorCustomersDAO = new MajorCustomerelpDAO();
        MajorCustomerelp majorCustomers = new MajorCustomerelp();
        ...
        if (path.equals(CommonConstants.MAJOR_CUST_DELETE)) {
            ...
            count = majorCustomerelpDAO.deleteCategory(id);
            if (count == 0) {
